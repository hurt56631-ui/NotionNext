...
export async function getSentenceCards({ databaseId }) {
    ...
    try {
        ...
        for (const pageId of pageIds) {
          ...
          if (isPublished) {
            const cleanTopic = { id: properties.id, word: properties['中文'] || '无内容', meaning: properties['缅语'] || '', example: properties['中文例句'] || '', burmeseExample: properties['缅文例句'] || '', pinyin: properties['拼音'] || null, imageUrl: properties['图片'] || null, courseIds: properties['所属课程'] || [] };
