// /pages/messages/index.js (最终修复版：对整个页面禁用SSR)
...
// ------------------------------------------------------------------
// 【核心修复】使用 dynamic import 导出整个页面，并禁用 SSR
// ------------------------------------------------------------------
const MessagesPageWithNoSSR = dynamic(
  () => Promise.resolve(MessagesPageContent), // 直接解析我们定义好的页面内容组件
  { ssr: false }
);

export default MessagesPageWithNoSSR;
