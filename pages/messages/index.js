...
#### 2. 创建新的 `ConversationList.js` 文件

为了让上面的动态导入生效，我们需要把 `ConversationList` 的逻辑抽离到一个单独的文件中。

1.  在您的**根目录 `components` 文件夹**下，创建一个新文件，名为 `ConversationList.js`。
2.  将以下**完整代码**粘贴到这个新文件中。
