...
const BLOG = {
  ...
  // === 【新增配置】这里添加您的 HSK 单词数据库ID ===
  NOTION_HSK_WORD_ID: process.env.NOTION_HSK_WORD_ID || '28fc928a2fa680f59325c71c16e29b2a', // HSK单词数据库ID
  // ==========================================
  ...
  BIO: process.env.NEXT_PUBLIC_BIO || '梅', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://tangly1024.com', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '中文网, 博客', // 网站关键词 英文逗号隔开
