...
// /components/ChatInterface.js (最终修复版 - 移除语法错误并集成日志)

import React, { useEffect, useState, useCallback, useRef } from "react";
import { db, rtDb } from "@/lib/firebase"; 
import { ref as rtRef, onValue } from 'firebase/database';
import { collection, query, orderBy, limit, onSnapshot, addDoc, serverTimestamp, doc, setDoc, getDoc, updateDoc, deleteDoc, increment, writeBatch, runTransaction } from "firebase/firestore";
