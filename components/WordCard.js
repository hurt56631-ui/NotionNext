// components/WordCard.js (最终稳定版 - 仅修复声调偏移样式)
...
const styles = {
    ...
    pinyinVisualizerContainer: { display: 'flex', alignItems: 'baseline', fontSize: '1.5rem', height: '1.8rem', color: '#333', fontFamily: '"Arial", "Helvetica", sans-serif' },
